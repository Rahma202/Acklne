...
@Component({
  selector: 'app-add-balacona',
  templateUrl: './add-balacona.component.html',
  styleUrls: ['./add-balacona.component.scss']
})
export class AddBalaconaComponent implements OnInit {
